                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                               ...
                               <input type="text" name="mobile_number_client" id="mobile_number_client" class="form-control">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="comment_client" name="comment_client" rows="3" maxlength="250"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                               ...
                               <input type="time" min="09:00" max="18:00" name="hour_service" id="hour_service" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                               ...
                               <input type="number" step="any" name="cost_service" class="form-control">
                            </div>
                        </div>
